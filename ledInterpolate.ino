...
void setup()
{
  ...
  {
    FastLED.addLeds<LED_TYPE, LedPin_C, COLOR_ORDER>(Config.ledBuffer[2], Config.numberOfLeds[2]);
  }
  if (Config.stripCount > 3)
  {
    FastLED.addLeds<LED_TYPE, LedPin_D, COLOR_ORDER>(Config.ledBuffer[3], Config.numberOfLeds[3]);
  }
...
void loop()
{
  ...
  { // send Data with format "xxxxxS" --> "1302T"; T:Target, A:Actual; int xxxxx: 32768 byte
